 ...
 *  ===
 *
 *  This is a modified version of https://github.com/awslabs/aws-solutions-constructs/blob/main/source/patterns/%40aws-solutions-constructs/aws-alb-fargate/lib/index.ts
 */
...
import {ContainerDefinitionProps, FargateServiceProps} from "aws-cdk-lib/aws-ecs";
...
export class AlbToFargate extends Construct {
    ...
    constructor(scope: Construct, id: string, props: AlbToFargateProps) {
        ...
        if (props.existingFargateServiceObject) {
            ...
            // region: modified
            const easyEditFargateService: FargateServiceProps = {
            ...
            const easyEditContainerDefinitionProps: ContainerDefinitionProps = {
                ...props.containerDefinitionProps,
                image: aws_ecs.ContainerImage.fromEcrRepository(props.repository, "image")
            };
            // endregion: modified
            ...
            const createFargateServiceResponse = defaults.CreateFargateService(scope, id, {
                ...
                clientContainerDefinitionProps: easyEditContainerDefinitionProps,
                clientFargateServiceProps: easyEditFargateService,
            });
